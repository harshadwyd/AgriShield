...
-- Insert sample achievements (using DO blocks to handle conflicts)
DO $$
BEGIN
...
-- Insert sample treatments (using DO blocks to handle conflicts)
DO $$
BEGIN
...
-- Insert sample educational content (using DO blocks to handle conflicts)
DO $$
BEGIN
