...
-- Create storage buckets (check if they exist first)
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM storage.buckets WHERE id = 'detection-images') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM storage.buckets WHERE id = 'educational-content') THEN
...
-- Insert sample achievements (check if they exist first)
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM achievements WHERE name = 'First Steps') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM achievements WHERE name = 'Farming Legend') THEN
        INSERT INTO achievements (id, name, description, category, rarity, requirements, reward_points) VALUES
...
-- Insert sample treatments (check if they exist first)
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM treatments WHERE name = 'Neem Oil') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM treatments WHERE name = 'Copper Fungicide') THEN
        INSERT INTO treatments (name, type, description, organic_certified, cost_per_liter, effectiveness_rating, safety_rating) VALUES
            ('Copper Fungicide', 'organic', 'Broad-spectrum fungicide for bacterial and fungal diseases', true, 22.00, 4, 4);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM treatments WHERE name = 'Insecticidal Soap') THEN
        INSERT INTO treatments (name, type, description, organic_certified, cost_per_liter, effectiveness_rating, safety_rating) VALUES
            ('Insecticidal Soap', 'organic', 'Gentle, non-toxic insecticide safe for beneficial insects', true, 12.75, 3, 5);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM treatments WHERE name = 'Spinosad') THEN
        INSERT INTO treatments (name, type, description, organic_certified, cost_per_liter, effectiveness_rating, safety_rating) VALUES
            ('Spinosad', 'biological', 'Biological insecticide derived from soil bacteria', true, 45.00, 4, 4);
    END IF;
    
    IF NOT EXISTS (SELECT 1 FROM treatments WHERE name = 'Bacillus thuringiensis') THEN
        INSERT INTO treatments (name, type, description, organic_certified, cost_per_liter, effectiveness_rating, safety_rating) VALUES
            ('Bacillus thuringiensis', 'biological', 'Biological insecticide targeting caterpillars and larvae', true, 28.50, 4, 5);
    END IF;
END $$;

-- Insert sample educational content (check if they exist first)
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM educational_content WHERE title = 'Organic Pest Management Fundamentals') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM educational_content WHERE title = 'Disease Prevention in Vegetable Crops') THEN
        INSERT INTO educational_content (title, description, content_type, category, difficulty_level, duration_minutes, content_url, downloadable, languages) VALUES
    ...
    IF NOT EXISTS (SELECT 1 FROM educational_content WHERE title = 'Seasonal Crop Care Calendar') THEN
        INSERT INTO educational_content (title, description, content_type, category, difficulty_level, duration_minutes, content_url, downloadable, languages) VALUES
    ...
    IF NOT EXISTS (SELECT 1 FROM educational_content WHERE title = 'Integrated Pest Management Strategies') THEN
        INSERT INTO educational_content (title, description, content_type, category, difficulty_level, duration_minutes, content_url, downloadable, languages) VALUES
    ...
    IF NOT EXISTS (SELECT 1 FROM educational_content WHERE title = 'Soil Health and Nutrition Management') THEN
        INSERT INTO educational_content (title, description, content_type, category, difficulty_level, duration_minutes, content_url, downloadable, languages) VALUES
